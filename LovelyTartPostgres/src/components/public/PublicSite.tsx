...
export const PublicSite: React.FC = () => {
  ...
  return (
    <div
      id="clientum-public-environment"
      data-design-system="clientum"
      className="min-h-screen bg-[var(--bg-canvas)] dark:bg-[#040711] text-[var(--text-primary)] dark:text-slate-100 flex flex-col justify-between selection:bg-blue-100 selection:text-blue-900 transition-colors duration-200"
    >
