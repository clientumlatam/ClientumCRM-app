...
export const MODULE_CREDENTIALS: ModuleCredentialDefinition[] = [
  ...
  {
    id: 'aiCopilot',
    label: 'AI Deal Copilot (OpenRouter / OpenAI)',
    group: 'Inteligencia artificial',
    description: 'Conexión de modelos de lenguaje avanzados para análisis de tratos, objeciones y estrategia comercial.',
    fields: [
      field('OPENROUTER_API_KEY', 'OpenRouter API Key', 'sk-or-v1-••••••••••••', 'Clave para acceder a Claude 3.5 Sonnet, DeepSeek R1, Llama 3.3 o GPT-4o vía OpenRouter.'),
      field('OPENROUTER_MODEL', 'Modelo OpenRouter', 'anthropic/claude-3.5-sonnet', 'Identificador del modelo en OpenRouter.'),
      field('OPENAI_API_KEY', 'OpenAI API Key', 'sk-proj-••••••••••••', 'Clave directa de OpenAI para modelos GPT-4o / GPT-4o-mini.'),
      field('OPENAI_MODEL', 'Modelo OpenAI', 'gpt-4o', 'Identificador del modelo en OpenAI.'),
      {
        ...field('PREFERRED_AI_PROVIDER', 'Proveedor Preferido', 'openrouter'),
        inputType: 'select',
        options: [
          { value: 'openrouter', label: 'OpenRouter (Recomendado - Multimodelo)' },
          { value: 'openai', label: 'OpenAI Directo' },
          { value: 'gemini', label: 'Google Gemini (Plataforma)' },
        ],
      },
    ],
    note: 'Tus claves se cifran con AES-256-GCM y sólo se usan para procesar las consultas de Deal Copilot en tu espacio de trabajo.',
  },
  { id: 'aiAssistant', label: 'Asistente Gemini 3.6', group: 'Inteligencia artificial', description: 'Copilot, resúmenes y asistencia generativa.', fields: [], note: 'Usa GEMINI_API_KEY de plataforma o las claves de aiCopilot.' },
